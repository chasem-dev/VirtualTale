...
A Hytale mod that runs a Game Boy, Game Boy Color, and Game Boy Advance emulator and streams the display onto Hytale's world map. Each player gets their own emulator instance.
